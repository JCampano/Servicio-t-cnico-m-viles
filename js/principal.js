...
function mostrarNuevaReparacion() {
    ...
    for (var i in oSAT._dispositivos) {
        if (oSAT._dispositivos[i].bActivo == true) {
            ...
            option.value = oSAT._dispositivos[i].sMarca + " " + oSAT._dispositivos[i].sModelo;
...
function validarAltaReparacion() {
    ...
    if (errores)
        ...
        var sMensaje = "";
        var modelo = document.frmAltaReparacion.repararDispositivo.value;
...
function validarModificarReparacion() {
    ...
    if (errores)
        ...
        var sMensaje = "";
        var modelo = document.frmModificarReparacion.repararDispositivo.value.trim();
...
function validarBajaReparacion() {
    ...
    if (document.frmBajaReparacion.repararDispositivo.value.trim() != "Lista de dispositivos en reparación") {
        var oReparacion = document.frmBajaReparacion.repararDispositivo.value.trim();
        document.frmBajaReparacion.repararDispositivo.style.background = "white";
        var bEncontrado = oSAT.bajaReparacion(oReparacion);
